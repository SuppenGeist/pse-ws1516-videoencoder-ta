...
\begin{itemize}
\item Libavcodec kompatible Dateitypen (z.B. MPEG,AVI,FLV)
\end{itemize}
...
Auswahl von einem oder mehreren Filtern, die auf das Video gelegt werden. Jeder Filter kann maximal einmal angewendet werden.
...
Laden von mehreren enodierten Videos. Die maximale Anzahl ist theorethisch nicht beschränkt. Es wird jedoch empfohlen nicht mehr als 6 Videos gleichzeitig zu laden. Akzeptierte Dateitypen wie in /F0020/.
...
Ein Filter soll im Schnitt für 300 Frames mit einer Auflösung von 176x144 nicht mehr als 3 Sekunden zum Berechnen benötigen.
...
Das Laden einer Filterkonfiguration soll nicht mehr als 2 Sekunden benötigen.
...
\item[]\textbf{/T012/}\qquad Filter auswählen und deren Reihenfolge und Eigenschaften ändern.
...
\item[]\textbf{/T031/}\qquad Beschädigtes/Fehlendes Video Laden und Fehlermeldung "'Video could not be opened"' erhalten.
\item[]\textbf{/T032/}\qquad Falsches Dateiformat laden und die Fehlermeldung "'Invalid file format"' erhalten.
\item[]\textbf{/T033/}\qquad Fehlende Schreib-/Leserechte und die Fehlermeldung "'Invalid permissions"' erhalten.
