...
\textbf{Behebung:} UndoStack wird vorm laden des Video geleert.
...
\textbf{Ursache:}\\
Der Undostack wird gelöscht, der Player aber nicht gestoppt. Der Player hat versucht ein geköschtes Video abzuspeielen.
\textbf{Behebung:}\\
Stoppen des Players vorm löschen des undosztacks.
\newpage
