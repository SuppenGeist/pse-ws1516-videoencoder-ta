...
UndoRedo::LoadFilterVideo::LoadFilterVideo(GUI::FilterTab& filterTab, std::unique_ptr<Model::YuvVideo> video,
                                           std::unique_ptr<Memento::FilterTabMemento> memento):memento_(std::move(memento)),filterTab_(&filterTab),video_(std::move(video)) {
