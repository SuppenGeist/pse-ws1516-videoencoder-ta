...
UndoRedo::LoadFilterconfig::LoadFilterconfig(GUI::FilterTab& filterTab, std::unique_ptr<Model::FilterList> newList):filterTab_(&filterTab),newList_(std::move(newList)) {
