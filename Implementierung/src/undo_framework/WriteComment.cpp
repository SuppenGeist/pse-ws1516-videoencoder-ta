...
UndoRedo::WriteComment::WriteComment(GUI::AnalysisBoxContainer *container, int index,
                                     QString oldcomment, QString newComment):container_(container),index_(index),oldComment_(oldcomment),
	newComment_(newComment) {
