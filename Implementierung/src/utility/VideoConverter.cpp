...
std::unique_ptr<Model::Video> Utility::VideoConverter::convertAVVideoToVideo(Model::AVVideo& avvideo) {
    auto video = std::make_unique<Model::Video>(avvideo.getFps(), avvideo.getWidth(),avvideo.getHeight());
...
std::unique_ptr<Model::AVVideo> Utility::VideoConverter::convertVideoToAVVideo(Model::Video& video) {
    auto avvideo = std::make_unique<Model::AVVideo>(video.getFps(), video.getWidth(),video.getHeight());
