...
Utility::Yuv411Vector::Yuv411Vector(unsigned char u, unsigned char y1, unsigned char y2,
                                    unsigned char v, unsigned char y3, unsigned char y4):u_(u),y1_(y1),y2_(y2),v_(v),y3_(y3),y4_(y4) {
