...
namespace Utility
{
	...
	class VideoConverter
	{
        ...
        public: static unique_ptr<QImage> convertAVFrameToQImage(AVFrame& frame, int width, int height);
        ...
        public: static unique_ptr<Model::Video> convertAVVideoToVideo(Model::AVVideo& video);
        ...
        public: static unique_ptr<AVFrame> convertQImageToAVFrame(QImage& image);
        ...
        public: static unique_ptr<Model::AVVideo> convertVideoToAVVideo(Model::Video& video);
	};
}
