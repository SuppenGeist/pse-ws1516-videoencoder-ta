...
void Utility::MacroblockCalculator::MacroBlockCalculator(Model::AVVideo& video) {
    this->video = &video;
}

void Utility::MacroblockCalculator::calculateMacroblockImages(Model::Video& target) {
    ff_print_debug_info(NULL, NULL);
}
