...
MeanSquareErrorCalculator::MeanSquareErrorCalculator(Model::Video &video1,
        Model::Video &video2):video1_(&video1),video2_(&video2) {
	if(video1.getWidth()!=video2.getWidth() || video1.getHeight()!=video2.getHeight()
	        || video1.getNumberOfFrames()!=video2.getNumberOfFrames()) {
