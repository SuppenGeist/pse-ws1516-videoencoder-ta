...
namespace Memento
{
	...
	class MainWindowMemento
	{
		...
		private: Memento::AnalysisTabMemento* analysisTab;
		private: Memento::FilterTabMemento* filterTab;
		...
		public: Memento::AnalysisTabMemento getAnalysisTabMemento();

		/// <summary>
		/// Sets the AnalysisTabMemento.
		/// </summary>
		/// <param name="analysisTabMeMento">The AnalysisTabMemento.</param>
		public: void setAnalysisTabMemento(Memento::AnalysisTabMemento analysisTabMeMento);

		/// <summary>
		/// Returns the FilterTabMemento.
		/// </summary>
		/// <returns>The FilterTabMemento.</returns>
		public: Memento::FilterTabMemento getFilterTabMemento();

		/// <summary>
		/// Sets the FilterTabMemento.
		/// </summary>
		/// <param name="filterTabMemento">The FilterTabMemento.</param>
		public: void setFilterTabMemento(Memento::FilterTabMemento filterTabMemento);
	};
}
